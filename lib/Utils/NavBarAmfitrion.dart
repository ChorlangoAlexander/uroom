...
class NavBarAmfitrion extends StatefulWidget {
  // const NavBarAmfitrion({super.key});
  String navAmfitrion;
  NavBarAmfitrion({required this.navAmfitrion});
  @override
  State<NavBarAmfitrion> createState() =>
      _NavBarAmfitrionState(id: navAmfitrion);
}

class _NavBarAmfitrionState extends State<NavBarAmfitrion> {
  ...
  _NavBarAmfitrionState({required this.id});
  @override
